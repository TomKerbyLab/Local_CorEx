...
```bash
pip install git+https://github.com/TomKerbyLab/Local_CorEx.git
```

## Development

Create a virtual environment, install the package in editable mode, and run tests or notebooks as needed.
